  ...
  Settings: {
    ...
    Sync: {
      ...
      Overview: (overview: any) => {
        return `${overview.chat} 次对话，${overview.message} 条消息，${overview.prompt} 条提示词，${overview.mask} 个范本`;
      },
      ImportFailed: "导入失败",
    },
    Mask: {
      Splash: {
        Title: "范本启动页",
        SubTitle: "新建聊天时，展示范本启动页",
      },
      Builtin: {
        Title: "隐藏内置范本",
        SubTitle: "在所有范本列表中隐藏内置范本",
      },
    },
    Prompt: {
      Disable: {
